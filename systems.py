...
class SistemaArquivos:
    def __init__(self):
        ...
        self.TEXT_FILES_MAP = {
            ...
            "PURGE.BAT": "ativar_purge.bat", # Alterado nome virtual
            "DESTROY.BAT": "ativar_server_destruct.bat", # Alterado nome virtual
        }
        ...
        self.estrutura = {
            "ST.AGNES": { # O diretório raiz
                "PESQUISAS": {
                    ...
                    "PURGE.BAT": [ # Alterado nome virtual do BAT
                        "@echo off",
                        ...
                        "ECHO Ativando temporizadores de detonação em 180 segundos.",
                ...
                "SERVIDOR": {
                    ...
                    "DESTROY.BAT": [ # Alterado nome virtual do BAT
                        "@echo off",
                        ...
                        "ECHO Ativando temporizadores de detonação em 180 segundos para servidores.",
        ...
        # Eles também devem ser mapeados no TEXT_FILES_MAP
        for i in range(1, 9):
    ...
    def ls(self, sistema_login_instance):
        ...
        for nome, conteudo in diretorio_atual_obj.items():
            ...
            # Alterado para usar os novos nomes de BAT
    ...
    def view(self, nome_arquivo, sistema_login_instance):
        ...
        if nome_arquivo_limpo in diretorio_atual_obj:
            ...
            if isinstance(conteudo_armazenado, dict):
                ...
                # --- Lógica para carregar conteúdo de TXT da pasta 'txt' ---
                if conteudo_armazenado == "LOAD_FROM_FILE":
                    if nome_arquivo_limpo in self.TEXT_FILES_MAP:
                        ...
                        try:
                            ...
                            if nome_arquivo_limpo == "PURGE.BAT": # Alterado nome
                                return (respostas, "ATIVAR_PURGE") # Estado ainda é "ATIVAR_PURGE"
                            elif nome_arquivo_limpo == "DESTROY.BAT": # Alterado nome
                                return (respostas, "ATIVAR_SERVER_DESTRUCT") # Estado ainda é "ATIVAR_SERVER_DESTRUCT"
