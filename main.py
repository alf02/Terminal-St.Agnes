...
print("DEBUG_INICIO: Iniciando loop principal do terminal.")
...
while True: # Loop externo para reiniciar o terminal completamente
    ...
    # --- Mensagens iniciais do histórico (agora controladas aqui no main.py) ---
    # Começa diretamente com o conteúdo de get_menu_inicial_mensagens, sem as linhas de "WELCOME" e "capslock"
    # Essas linhas (WELCOME, capslock) não são mais adicionadas por default se elas não estão em get_menu_inicial_mensagens
    mensagens_historico = menus_commands.get_menu_inicial_mensagens() 
    
    # Adiciona as mensagens de HELP logo após as iniciais customizadas
    ...
    # Qualquer tecla pressionada durante as telas iniciais é consumida e descartada por elas.
    # Limpamos a fila aqui para que apenas NOVOS eventos sejam processados no loop principal interativo.
    pygame.event.clear() 
    ...
    while rodando:
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.QUIT:
                rodando = False # Sair do loop interno
